...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'dgc12@tjyg0.onmicrosoft.com',
  ...
  title: "TeamKurosaki Index",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/Proyectos-Publicados',
  ...
  links: [
    {
      name: 'Discord',
      link: 'https://discord.com/invite/R8xKYZXksG',
    },
  ],
